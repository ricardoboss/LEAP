...
public interface ILibraryStorage
{
	...
	public Task<StorageMetadata?> GetMetadataAsync(string author, string name, string version,
		CancellationToken cancellationToken = default);

	public Task SetMetadataAsync(string author, string name, string version, StorageMetadata metadata,
		CancellationToken cancellationToken = default);

	public Task<Stream> OpenReadAsync(string author, string name, string version,
		CancellationToken cancellationToken = default);
