	...
	: ILibraryStorage
{
	...
	/// <inheritdoc />
	public async Task<StorageMetadata?> GetMetadataAsync(string author, string name, string version,
		CancellationToken cancellationToken = default)
	{
	...
	/// <inheritdoc />
	public async Task<Stream> OpenReadAsync(string author, string name, string version,
		CancellationToken cancellationToken = default)
	{
		if (!await ExistsAsync(author, name, version, cancellationToken))
		...
		logger.LogTrace("Reading library for {Author}/{Name}@{Version} from {Path}", author, name, version,
	...
	/// <inheritdoc />
	public async Task DeleteAsync(string author, string name, string version,
		CancellationToken cancellationToken = default)
	{
		if (!await ExistsAsync(author, name, version, cancellationToken))
			return;
